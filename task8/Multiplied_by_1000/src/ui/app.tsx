...
export function App() {
    ...
    return (
        <div>
            ...
            <hr />
            <p>
                The button below will deploy a x1000 Game 🚀🚀🚀 smart contract where you can input a
                ...
                read x1000 value from smart contract or set a new one. You can do that using the
                interface below.
            </p>
